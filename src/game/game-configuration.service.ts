...
import { GameStatistics, PopulatedConsultation, Winner, WinningStats } from '@/common/interfaces';
...
export class GameConfigurationService {
  ...
  async exportEditionResults(editionId: string): Promise<{
    ...
    const winnersstats = winningStats.winningStats;
    return {
      edition: {
        id: edition._id,
      ...
      winners: {
        exact: winnersstats?.exactWinners || [],
        disordered: winnersstats?.disorderedWinners || [],
      },
      statistics: winnersstats!.statistics,
